...
<header class="main-header">
 <?php require_once('menu_ps_uptd/nav.php'); ?>
 <?php require_once('menu_ps_uptd/side.php'); ?>
<!-- aside here -->
  ...
  <div class="content-wrapper" style="background-image: url('gambar.jpg'); background-size: cover;">
    ...
    <!-- Main content -->
    <section class="content" style="opacity: 0.95;">
      <div class="row">
        <div class="col-md-12">
          <div class="box">
 ...
 <?php require_once('menu_ps_uptd/footer.php'); ?>
