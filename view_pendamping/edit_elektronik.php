...
<body>
    ...
    <a class="btn btn-primary" href="http://localhost/siks_ahp/dashboard_pendamping.php?page=view_pendamping/keterampilan_elektronik"> << Kembali</a>
    <br/><br/>

    <form name="update_user" method="post" action="edit_elektronik.php">
