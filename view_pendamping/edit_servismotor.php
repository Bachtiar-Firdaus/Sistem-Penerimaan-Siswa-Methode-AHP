...
{   
    ...
    header("Location:http://localhost/siks_ahp/dashboard_pendamping.php?page=view_pendamping/keterampilan_servismotor");
}
?>
<?php
...
<body>
    ...
    <a class="btn btn-primary" href="http://localhost/siks_ahp/dashboard_pendamping.php?page=view_pendamping/keterampilan_servismotor"> << Kembali</a>
    <br/><br/>

    <form name="update_user" method="post" action="edit_servismotor.php">
...
$result = mysqli_query($mysqli, "SELECT * FROM tbl_pendamping ORDER BY id DESC ");
  ...
  <!-- <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleFormControlInput1"  name="penilaian" value="<?php echo $penilaian;?>">
  </div> -->
