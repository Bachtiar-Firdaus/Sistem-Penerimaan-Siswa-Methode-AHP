...
<div class="containeredit" style="overflow: scroll;">
  ...
  <h2>Keterampilan Elektronik</h2> <hr>

  <form method="post" action="view_pendamping/sortir_elektronik.php">
...
<select name="nama_siswa">
  ...
  include_once("\insert\config.php");
$result = mysqli_query($mysqli,"SELECT DISTINCT nama_siswa FROM tbl_kegiatan where jurusann ='servis elektronik'  order by id_kegiatan ASC; "); 
...
ON tbl_cs2.id=tbl_kegiatan.id_kegiatan  where jurusann = 'Servis Elektronik'");
    ...
    while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td><a href='/siks_ahp/view_pendamping/edit_elektronik.php?id_kegiatan=$user_data[id_kegiatan]'>Edit</a> || <a href='/siks_ahp/view_pendamping/delete_elektronik.php?id_kegiatan=$user_data[id_kegiatan]'>Delete</a></td></tr>";      
    }
