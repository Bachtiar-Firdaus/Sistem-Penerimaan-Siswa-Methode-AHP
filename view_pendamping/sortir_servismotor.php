  ...
  if (isset($_POST['search'])) {
    ...
    $query = mysqli_query($mysqli, " SELECT * FROM tbl_kegiatan WHERE nama_siswa = '$nama_siswa' and nama_pendamping = '$nama_pendamping' and year(tanggal) ='$tanggall' ");
...
// ON tbl_cs2.id=tbl_kegiatan.id_kegiatan  WHERE nama_siswa = '$nama_siswa' and nama_pendamping = '$nama_pendamping' and year(tanggal) = '$tanggal' ");
  ...
  <div class="row" style="height: 124px;">
    ...
    <p align="center" class="cop2">BANDAR LAMPUNG TAHUN  <?php echo "".date('Y',strtotime($row_query['tanggall'])).""; ?></p>
