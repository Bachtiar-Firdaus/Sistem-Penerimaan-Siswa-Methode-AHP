...
{   
    ...
    header("Location:http://localhost/siks_ahp/dashboard_pendamping.php?page=view_pendamping/keterampilan_tatarias");
}
?>
<?php
...
<body>
    ...
    <a class="btn btn-primary" href="http://localhost/siks_ahp/dashboard_pendamping.php?page=view_pendamping/keterampilan_tatarias"> << Kembali</a>
    <br/><br/>

    <form name="update_user" method="post" action="edit_tatarias.php">
