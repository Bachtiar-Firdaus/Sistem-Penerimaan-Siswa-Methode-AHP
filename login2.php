...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "dashboard_pendamping.php";
  $MM_redirectLoginFailed = "login2.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_koneksi, $koneksi);
  
  $LoginRS__query=sprintf("SELECT username, password FROM tb_users WHERE username=%s AND password=%s AND fullname='pendamping'",
...
<body style="background-image: linear-gradient(#bbdefb, #e3f2fd)">
  <div class="kotak_login border" style="background-color: #006db3;">
    <b>
      <p class="tulisan_login" style="color: white">Silahkan login - Pendamping</p>
    </b>
