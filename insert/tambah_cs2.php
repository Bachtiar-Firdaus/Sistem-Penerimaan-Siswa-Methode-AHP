...
{   
    ...
    // update user data
    $result = mysqli_query($mysqli, "INSERT INTO tbl_cs2 SET nama = '$nama',umur = '$umur', jk = '$jk', ttl = '$ttl', agama = '$agama', suku = '$suku', bahasa = '$bahasa', ald = '$ald', alk = '$alk', alko = '$alko', ltlsk = '$ltlsk', pt = '$pt', atls = '$atls', km = '$km', mn = '$mn', pb = '$pb', bpbd = '$bpbd', gp = '$gp', tanggal = '$tanggal', keterangan = '$keterangan',nama_ayah = '$nama_ayah',nama_ibu = '$nama_ibu',umur_ayah = '$umur_ayah',umur_ibu = '$umur_ibu',agama_ayah = '$agama_ayah',agama_ibu = '$agama_ibu',alm_desa_ayah = '$alm_desa_ayah',alm_kec_ayah = '$alm_kec_ayah',alm_kab_ayah = '$alm_kab_ayah',alm_desa_ibu = '$alm_desa_ibu',alm_kec_ibu = '$alm_kec_ibu',alm_kab_ibu = '$alm_kab_ibu',pekerjaan_ayah = '$pekerjaan_ayah',pekerjaan_ibu = '$pekerjaan_ibu',jumlah_saudara = '$jumlah_saudara'");
...
: <input type="text"  name="nama">
    ...
    <tr>
      <td>2</td>
      <td>Umur</td>
      <td colspan="3">: <input type="number"  name="umur"></td>
    </tr>
    <tr>
      <td>3</td>
      <td>Jenis Kelamin</td>
